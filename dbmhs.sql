...
--
-- Host: 127.0.0.1
-- Generation Time: 12 Nov 2019 pada 02.30
...
(5, '161240000705', 'cahya', 'perempuan', 'tahunan rt 01/06', '085343487438');
...
--
ALTER TABLE `loh_update`
  MODIFY `id_log` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
